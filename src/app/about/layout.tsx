...
export const metadata: Metadata = {
  ...
  description:
    "Learn about JOTOFA GROUP   a diversified Tanzanian holding company with 10+ years of impact across ICT, logistics, cleaning, security, and staffing. Meet our leadership, mission, and vision.",
  openGraph: {
