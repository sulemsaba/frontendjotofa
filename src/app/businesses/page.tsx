...
export const metadata: Metadata = {
  ...
  description:
    "Explore JOTOFA GROUP's three industry-leading subsidiaries: UTEC Solutions (ICT), JOTOFA Cleaning, and JOTOFA Staffing.",
  openGraph: {
    title: "Our Businesses - JOTOFA GROUP Subsidiaries",
    description:
      "Explore our three industry-leading subsidiaries spanning ICT, cleaning, and staffing.",
