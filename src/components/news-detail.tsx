        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8 lg:gap-12">
          ...
          >
            ...
            <nav className="text-xs text-muted-foreground mb-4 flex items-center gap-1.5 flex-wrap" aria-label="Breadcrumb">
              <PageLink page="home" className="hover:text-jotofa-accent transition-colors">
                Home
              </PageLink>
              <span>&bull;</span>
            ...
            <div className="article-body">
              ...
              <blockquote className="my-8 p-5 sm:p-6 rounded-xl bg-jotofa-accent/[0.04] border border-jotofa-accent/15 relative overflow-hidden">
                ...
                <footer className="flex items-center gap-2 text-xs text-muted-foreground font-medium">
        ...
        >
          ...
          <div className="relative z-10 p-8 sm:p-10 lg:p-12 max-w-xl">
            ...
            <div className="flex flex-wrap gap-3">
              <PageLink
                page="contact"
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-white text-jotofa-navy font-semibold text-sm hover:bg-white/90 transition-all duration-200"
              >
                Contact Us
