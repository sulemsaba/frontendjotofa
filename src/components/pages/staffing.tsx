  ...
  return (
    <div className="bg-background">
      <section className="relative min-h-[70vh] flex items-center py-28 sm:py-36 overflow-hidden">
        ...
        <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-staffing-purple/5 rounded-full blur-[140px]" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-3xl">
              {stats.map((stat) => (
                <div key={stat.label} className="text-center p-4 rounded-xl bg-card border border-border">
                  <div className="text-2xl sm:text-3xl font-bold text-staffing-purple">{stat.value}</div>
      ...
      <section className="relative py-20 sm:py-28">
        <div className="absolute inset-0 bg-background" />
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-staffing-purple/15 to-transparent" />

        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3">
              Our <span className="text-staffing-purple">Services</span>
            </h2>
          </ScrollReveal>
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.1}>
            {services.map((service) => (
              <StaggerItem key={service.title}>
                <div className="group h-full p-6 rounded-2xl bg-card border border-border hover:border-staffing-purple/25 transition-all duration-300 hover:bg-secondary">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-staffing-purple/10 mb-5">
                    <service.icon className="w-6 h-6 text-staffing-purple" />
                  </div>
      ...
      <Testimonials
        ...
        title={<>What Our <span className="text-jotofa-accent">HR Clients Say</span></>}
      ...
      <section className="relative py-20">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <div className="p-10 rounded-2xl border border-staffing-purple/15 bg-staffing-purple/[0.03]">
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                Need <span className="text-staffing-purple">Reliable Staff</span>?
              </h2>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-staffing-purple hover:bg-staffing-purple/90 text-white font-semibold rounded-full transition-all"
              >
